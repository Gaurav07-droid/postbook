...
exports.passwordChange = exports.login = void 0;
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"postFunc.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0, _axios.default)({
              url: "http://127.0.0.1:3000/api/v1/posts/".concat(postId, "/likes"),
              method: "POST"
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return (0, _axios.default)({
              url: "http://127.0.0.1:3000/api/v1/likes/".concat(postId),
              method: "DELETE"
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return (0, _axios.default)({
              url: "http://127.0.0.1:3000/api/v1/posts/".concat(postId),
              method: "PATCH"
            });
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 3;
            return (0, _axios.default)({
              url: "http://127.0.0.1:3000/api/v1/posts/".concat(postId, "/comments"),
              method: "POST",
              data: {
                comment: comment
              }
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return (0, _axios.default)({
              url: "http://127.0.0.1:3000/api/v1/users/".concat(userId, "/follow"),
              method: "POST"
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            ...
            _context5.next = 7;
            return (0, _axios.default)({
              url: "http://127.0.0.1:3000/api/v1/follow/".concat(followingId),
              method: "DELETE"
            });
