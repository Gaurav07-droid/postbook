...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"../../node_modules/xss-filters/src/xss-filters.js":[function(require,module,exports) {
/*
...
},{}],"../../node_modules/xss-clean/lib/xss.js":[function(require,module,exports) {
'use strict';
...
},{"xss-filters":"../../node_modules/xss-filters/src/xss-filters.js"}],"alert.js":[function(require,module,exports) {
"use strict";
...
exports.signup = exports.passwordChange = exports.login = void 0;

var _axios = _interopRequireDefault(require("axios"));

var _xss = require("xss-clean/lib/xss.js");
...
var passwordChange = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)("error", _context3.t0.response.data.message.includes("passwordConfirm:") ? _context3.t0.response.data.message.split("passwordConfirm:")[1] : _context3.t0.response.data.message); // console.log(err);
  ...
  return function passwordChange(_x3, _x4, _x5) {
...
var signup = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(username, name, email, password, passwordConfirm) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js","xss-clean/lib/xss.js":"../../node_modules/xss-clean/lib/xss.js","./alert.js":"alert.js"}],"postFunc.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.unlikePost = exports.likePost = exports.deletePostAdmin = exports.deletePost = exports.createPost = exports.createComment = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Post uploaded successfully!");
              window.setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)("error", "Post must require an image and description!");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alert.showAlert)("error", "You can only like a post once!");
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return (0, _axios.default)({
              url: "/api/v1/likes/".concat(postId),
              method: "DELETE"
            });
          ...
          case 7:
            _context3.prev = 7;
            _context3.t0 = _context3["catch"](0);
            (0, _alert.showAlert)("error", "You can only unlike a post once!");
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alert.showAlert)("success", "Post deleted successfully!");
              window.setTimeout(function () {
                location.reload(true);
              }, 1000);
            }
...
var deletePostAdmin = /*#__PURE__*/function () {
  ...
  return function deletePostAdmin(_x5) {
...
var createComment = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(comment, postId) {
    var res;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            // console.log(res);
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Commented successfully!"); // window.setTimeout(() => {
              //   // location.reload(true);
              // }, 1000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"userFunc.js":[function(require,module,exports) {
"use strict";
...
var _postFunc = require("./postFunc");
...
var btnDeletePost = document.querySelectorAll(".delete-post");
...
var btnUnfollow = document.querySelector(".btn-unfollow");
...
if (formSignup) formSignup.addEventListener("submit", function (e) {
  e.preventDefault();
  (0, _auth.signup)(userName.value, name.value, email.value, password.value, confPassword.value);
});
if (loginForm) loginForm.addEventListener("submit", function (e) {
  e.preventDefault();
  (0, _auth.login)(username.value, password.value);
});
if (btnLogout) btnLogout.addEventListener("click", function () {
  (0, _auth.logout)();
});
if (formCreatePost) formCreatePost.addEventListener("submit", function (e) {
  e.preventDefault();
  ...
  (0, _postFunc.createPost)(form);
});
if (formUpdateMe) formUpdateMe.addEventListener("submit", function (e) {
  e.preventDefault();
  var form = new FormData();
...
if (formPasswordChange) formPasswordChange.addEventListener("submit", function (e) {
  e.preventDefault();
  (0, _auth.passwordChange)(curPassword.value, password.value, confPassword.value);
});
if (btnLike) btnLike.forEach(function (btn) {
  return btn.addEventListener("click", function (e) {
    var postId = e.target.dataset.postid;
    (0, _postFunc.likePost)(postId);
    e.target.textContent = "Liked";
  });
});
if (btnUnlike) btnUnlike.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var postId = e.target.dataset.postid;
    (0, _postFunc.unlikePost)(postId);
    e.target.textContent = "Unliked";
  });
});
if (btnDeletePost) btnDeletePost.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var postId = e.target.dataset.postid;
    (0, _postFunc.deletePost)(postId);
  });
});
if (btnDelPost) btnDelPost.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var postId = e.target.dataset.postid;
    (0, _postFunc.deletePostAdmin)(postId);
  });
});
if (btnDeleteUser) btnDeleteUser.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    var userId = e.target.dataset.userid;
    (0, _userFunc.deleteUser)(userId);
  });
});
if (btnDeleteMe) btnDeleteMe.addEventListener("click", function (e) {
  var confirm = prompt("Please type 'Delete' to delete your account.", "Type here..");

  if (confirm === "Delete") {
    (0, _userFunc.deleteMe)();
  } else {
    return location.reload(true);
  }
});
if (btnRemoveProfile) btnRemoveProfile.addEventListener("click", function () {
  (0, _userFunc.removeProfile)();
});
btnCmmnt.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    e.preventDefault();
    var postId = e.target.dataset.postid;
    cmmntText.forEach(function (cmmnt) {
      if (cmmnt.value) {
        var comment = cmmnt.value;
        (0, _postFunc.createComment)(comment, postId);
...
if (btnFollow) btnFollow.addEventListener("click", function (e) {
  var userId = e.target.dataset.userid;
  var userName = e.target.dataset.username;
  (0, _userFunc.followUser)(userId, userName); // btnFollow.removeChild(".btn-follow");
});
if (btnUnfollow) btnUnfollow.addEventListener("click", function (e) {
  var userId = e.target.dataset.userid;
  var userName = e.target.dataset.username;
